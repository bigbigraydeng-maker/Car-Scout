 ...
 *
 * 基于 TradeMe 真实挂牌数据的 KNN 加权中位数估价
 *
 * 算法:
...
// ─── TM 挂牌价 → 快速成交价 转换 ───
// TM 挂牌价是卖家期望价（市场天花板），快速私人成交价存在系统性价差:
//   - 议价空间: 卖家通常接受 85-90% 的挂牌价
//   - 平台价差: FB/快速出售价 < TM 挂牌价 15-20%
//   - 车况折扣: 翻卖车通常非 pristine 状态
// 综合折算: 快速成交价 ≈ TM 挂牌价 × 0.55
const ASKING_TO_SALE_FACTOR = 0.55;
